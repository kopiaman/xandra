...
$result = array(
    ...
    'main' => array(
        'custom' => array(
            'label' => __('Custom Slider', 'motopress-slider'),
            'id' => 'mpsl-custom-slider',
            'slider_type' => 'custom',
			'description' => __('create unlimited slides with images, text, buttons and videos', 'motopress-slider'),
            'selected' => true
        ),
        'post' => array(
            'label' => __('Posts Slider', 'motopress-slider'),
            'id' => 'mpsl-post-slider',
            'slider_type' => 'post',
			'description' => __('create from posts of your website', 'motopress-slider'),
            'selected' => false
        ),
    ),
    ...
    'sample' => array(
	    'custom-1' => array(
            'label' => __('Custom Slider #1', 'motopress-slider'),
            'id' => 'custom-1',
            'slider_type' => 'custom',
		    'image_dir' => '',
	    ...
	    'post-1' => array(
            'label' => __('Posts Slider #1', 'motopress-slider'),
            'id' => 'post-1',
            'slider_type' => 'post',
...
if(is_plugin_active('woocommerce/woocommerce.php')) {
    $result['main']['woocommerce'] = array(
        'label' => __('WooCommerce Slider', 'motopress-slider'),
        'id' => 'mpsl-woocommerce-slider',
        'slider_type' => 'woocommerce',
        'selected' => false,
        'description' => __('create from WooCommerce products', 'motopress-slider'),
    );
    $result['sample']['woocommerce-1'] = array(
        'label' => __('WooCommerce Slider #1', 'motopress-slider'),
        'id' => 'woocommerce-1',
        'slider_type' => 'woocommerce',
        'selected' => false,
