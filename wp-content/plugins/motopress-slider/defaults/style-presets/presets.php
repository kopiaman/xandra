...
return array(
	'mpsl-btn-blue' => array(
		'settings' => array(
			'label' => __('Button Blue', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
...
CONTENT
	...
	'mpsl-btn-green' => array(
		'settings' => array(
			'label' => __('Button Green', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
			'font-family' => 'Open Sans',
...
CONTENT
	...
	'mpsl-btn-red' => array(
		'settings' => array(
			'label' => __('Button Red', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
			'font-family' => 'Open Sans',
...
CONTENT
	...
	'mpsl-txt-header-dark' => array(
		'settings' => array(
			'label' => __('Header Dark', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
			'font-family' => 'Open Sans',
...
CONTENT
	...
	'mpsl-txt-header-white' => array(
		'settings' => array(
			'label' => __('Header White', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
			'font-family' => 'Open Sans',
...
CONTENT
	...
	'mpsl-txt-sub-header-dark' => array(
		'settings' => array(
			'label' => __('Sub-Header Dark', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
			'font-family' => 'Open Sans',
	...
	'mpsl-txt-sub-header-white' => array(
		'settings' => array(
			'label' => __('Sub-Header White', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
			'font-family' => 'Open Sans',
	...
	'mpsl-txt-dark' => array(
		'settings' => array(
			'label' => __('Text Dark', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
			'font-family' => 'Open Sans',
	...
	'mpsl-txt-white' => array(
		'settings' => array(
			'label' => __('Text White', 'motopress-slider'),
			'hover' => true
		),
		'style' => array(
			'font-family' => 'Open Sans',
