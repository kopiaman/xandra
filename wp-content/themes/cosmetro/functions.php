...
if (!class_exists('Cosmetro_Theme_Setup')) {
	...
	class Cosmetro_Theme_Setup
	{
		...
		public function includes()
		{
			...
			require_once trailingslashit(COSMETRO_THEME_WIDGETS) . 'cosmetro-carousel-widget/class-cosmetro-carousel-widget.php';
			require_once trailingslashit(COSMETRO_THEME_WIDGETS) . 'cosmetro-smart-slider-widget/class-cosmetro-smart-slider-widget.php';
		...
		public function init()
		{
			...
			$this->get_core()->init_module('cherry-post-meta', array(
				...
				'callback_args' => false,
				'fields'        => array(
					'cosmetro_sidebar_position' => array(
						'type'          => 'radio',
		...
		public function enqueue_assets()
		{
			...
			$labels = apply_filters('cosmetro_theme_localize_labels', array(
				'totop_button' => '<i class="material-icons">keyboard_arrow_up</i>',
			));
