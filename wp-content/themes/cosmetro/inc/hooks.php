...
function cosmetro_modify_comment_form($args)
{
	...
	$args['comment_field'] = '<p class="comment-form-comment"><textarea id="comment" class="comment-form__field" name="comment" placeholder="' . esc_html__('Your Comment: ', 'cosmetro') . '" cols="45" rows="8" aria-required="true" required="required"></textarea></p>';
...
add_action('admin_menu', 'cosmetro_remove_tiny_grid_menu', 999);
function cosmetro_remove_tiny_grid_menu()
{
