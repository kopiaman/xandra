...
if (!function_exists('cosmetro_product_search')) {
	...
	{
		if (cosmetro_is_woocommerce_activated()) { ?>
 ...
 */
if (!function_exists('cosmetro_is_woocommerce_activated')) {
	function cosmetro_is_woocommerce_activated()
	{
 ...
 */
if (!function_exists('cosmetro_is_wc_jetpack')) {
	function cosmetro_is_wc_jetpack()
	{
...
if (!function_exists('cosmetro_cart_link')) {
	function cosmetro_cart_link()
	{
		...
		<div class="cart-contents">
			<span class="count"><i
					class="fl-flat-icons-set-2-shopping191"></i><span><?php echo WC()->cart->get_cart_contents_count(); ?></span><span
					class="item_txt"><?php echo esc_html__('items', 'cosmetro') ?></span></span>
		</div>
		<?php
	}
}
			...
			<ul class="site-header-cart navbar-header-cart menu">
				...
				<li class="header-cart-dropdown">
					<div class="shopping_cart-dropdown-wrap">
						<h4><?php echo esc_html__('Cart', 'cosmetro') ?></h4>
