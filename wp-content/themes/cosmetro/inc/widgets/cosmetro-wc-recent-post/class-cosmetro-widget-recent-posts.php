 ...
 * @see WP_Widget
 */
class Cosmetro_WP_Widget_Recent_Posts extends WP_Widget_Recent_Posts
{
	...
	public function widget($args, $instance)
	{
		...
		$title = (!empty($instance['title'])) ? $instance['title'] : esc_html__('Recent Posts', 'cosmetro');
	...
	public function form($instance)
	{
		...
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title:', 'cosmetro'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>"
				name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>"/></p>

		<p><label
				for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e('Number of posts to show:', 'cosmetro'); ?></label>
		...
		<p><input class="checkbox" type="checkbox"<?php checked($show_date); ?>
			...
			<label
				for="<?php echo $this->get_field_id('show_date'); ?>"><?php esc_html_e('Display post date?', 'cosmetro'); ?></label>
		</p>
		...
		<p><input class="checkbox" type="checkbox"<?php checked($show_author); ?>
			...
			<label
				for="<?php echo $this->get_field_id('show_author'); ?>"><?php esc_html_e('Display post author?', 'cosmetro'); ?></label>
		</p>
		<?php
	}
}
