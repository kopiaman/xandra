 ...
 * @package Cosmetro
 */
class Cosmetro_Smart_Slider_Widget extends Cherry_Abstract_Widget
{
	...
	{
		$this->widget_cssclass = 'cosmetro widget_smart_slider';
		$this->widget_description = esc_html__('Display smart slider on your site.', 'cosmetro');
		$this->widget_id = 'widget_smart_slider';
		$this->widget_name = esc_html__('Smart Slider Widget', 'cosmetro');
		$this->settings = array(
			'title'               => array(
				'type'  => 'text',
				'value' => esc_html__('Smart Slider', 'cosmetro'),
			...
			'categories'          => array(
				...
				'options'          => false,
				'label'            => esc_html__('Select category', 'cosmetro'),
				'multiple'         => true,
				'placeholder'      => esc_html__('Select category', 'cosmetro'),
			...
			'tags'                => array(
				...
				'options'          => false,
				'label'            => esc_html__('Select tags', 'cosmetro'),
				'multiple'         => true,
				'placeholder'      => esc_html__('Select tags', 'cosmetro'),
			...
			'posts_per_page'      => array(
				...
				'max_value' => 50,
				'min_value' => 1,
				'label'     => esc_html__('Posts count', 'cosmetro'),
			),
			'post_title'          => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Display title', 'cosmetro'),
			),
			'content'             => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Display content', 'cosmetro'),
			),
			'more_button'         => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Display more button', 'cosmetro'),
			),
			'more_button_text'    => array(
				'type'  => 'text',
				'value' => esc_html__('Read more', 'cosmetro'),
				'label' => esc_html__('More button text', 'cosmetro'),
			),
			'trim_words'          => array(
				'type'       => 'slider',
				'value'      => 15,
				...
				'min_value'  => 1,
				'step_value' => 1,
				'label'      => esc_html__('Content words trimmed count', 'cosmetro'),
			),
			'width'               => array(
				'type'  => 'text',
				'value' => '100%',
				'label' => esc_html__('Slider width', 'cosmetro'),
			),
			'height'              => array(
				'type'  => 'text',
				'value' => '800',
				'label' => esc_html__('Slider height', 'cosmetro'),
			),
			'orientation'         => array(
				'type'    => 'select',
				'size'    => 1,
				...
				'label'   => esc_html__('Slider orientation', 'cosmetro'),
			),
			'slide_distance'      => array(
				...
				'max_value' => 100,
				'min_value' => 0,
				'label'     => esc_html__('Slide distance(px)', 'cosmetro'),
			),
			'slide_duration'      => array(
				...
				'min_value'  => 100,
				'step_value' => 100,
				'label'      => esc_html__('Slide duration(ms)', 'cosmetro'),
			),
			'slide_fade'          => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Use fade effect?', 'cosmetro'),
			),
			'navigation'          => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Use navigation?', 'cosmetro'),
			),
			'fade_navigation'     => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Indicates whether the arrows will fade in only on hover', 'cosmetro'),
			),
			'pagination'          => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Use pagination?', 'cosmetro'),
			),
			'autoplay'            => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Use autoplay?', 'cosmetro'),
			),
			'fullScreen'          => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Display fullScreen button?', 'cosmetro'),
			),
			'shuffle'             => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Indicates if the slides will be shuffled', 'cosmetro'),
			),
			'loop'                => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Use infinite scrolling?', 'cosmetro'),
			),
			'thumbnails'          => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Display thumbnails?', 'cosmetro'),
			),
			'thumbnails_arrows'   => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => (wp_is_mobile()) ? 'normal' : 'small',
				'label' => esc_html__('Display thumbnails arrows?', 'cosmetro'),
			),
			'thumbnails_position' => array(
				...
				'options' => array(
					...
					'bottom' => esc_html__('Bottom', 'cosmetro'),
					'right'  => esc_html__('Right', 'cosmetro'),
					'left'   => esc_html__('Left', 'cosmetro'),
				),
				'label'   => esc_html__('Sets the position of the thumbnail scroller', 'cosmetro'),
			),
		);
	...
	public function widget($args, $instance)
	{
		...
		if ($posts_query) {
			...
			$html = '<h4>' . esc_html__('Posts for slider not found', 'cosmetro') . '</h4>';
		}
	...
	public function render_slider($posts_query)
	{
		...
		$html = '<div class="cosmetro-smartslider" ' . $slider_html_attr . '>';
		$html .= '<div id="' . $uniq_id . '" class="cosmetro-smartslider__instance slider-pro">';
		$html .= '<div class="cosmetro-smartslider__slides sp-slides">';
		$html .= $this->get_slider_loop($posts_query);
		$html .= '</div>';

		if ('true' == $this->instance['thumbnails']) {
			$html .= '<div class="cosmetro-smartslider__thumbnails sp-thumbnails">';
	...
	public function get_query_slider_items($query_args = array())
	{
		...
		$defaults_query_args = apply_filters('cosmetro_smart_slider_default_query_args', array(
			'post_type'      => 'post',
			'orderby'        => 'date',
			'order'          => 'DESC',
			'posts_per_page' => -1,
	...
	public function get_slider_loop($posts_query)
	{
		 ...
		 * @var  array
		 */
		$title_settings = apply_filters('cosmetro_smart_slider_title_settings', array(
		 ...
		 * @var  array
		 */
		$content_settings = apply_filters('cosmetro_smart_slider_content_settings', array(
		 ...
		 * @var  array
		 */
		$more_settings = apply_filters('cosmetro_smart_slider_more_button_settings', array(
		...
		$placeholder_args = apply_filters('cosmetro_smart_slider_placeholder_args', array(
			'width'  => 1600,
	...
	public function get_slider_thumbnails($posts_query)
	{
		...
		$thumbnail_size = apply_filters('cosmetro_smart_slider_thumbnail_size', 'cosmetro-thumb-240-100', $this->instance);
	...
	public function get_image($id, $size, $placeholder_attr, $only_url = false)
	{
		...
		if (has_post_thumbnail($id)) {
			...
			$default_placeholder_attr = apply_filters('cosmetro_smart_slider_placeholder_default_args', array(
				'width'      => 900,
				'height'     => 500,
				'background' => 'eef4fa',
				'foreground' => '298ffc',
...
add_action('widgets_init', 'cosmetro_register_smart_slider_widgets');
function cosmetro_register_smart_slider_widgets()
{
	register_widget('Cosmetro_Smart_Slider_Widget');
}