...
if (!class_exists('Cosmetro_Widget_Area')) {

	class Cosmetro_Widget_Area
	{
		...
		function __construct()
		{
			...
			add_action('cosmetro_render_widget_area', array($this, 'render'));
		}
		...
		public function render($area_id)
		{
			...
			$area_id = apply_filters('cosmetro_rendering_current_widget_area', $area_id);
			...
			$classes = apply_filters('cosmetro_widget_area_classes', $classes, $area_id);
	...
	function cosmetro_widget_area()
	{
		return Cosmetro_Widget_Area::get_instance();
	}

	cosmetro_widget_area();
}
